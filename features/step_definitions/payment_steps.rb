E("seleciono a opção Pay by bank wire") do
    payment.click_payment_bank_wire
end

E("clico no botão I confirm my order") do
    payment.click_button_confirm_order
end

Então("valido as seguintes informações da tela Order Confirmation") do |table|
